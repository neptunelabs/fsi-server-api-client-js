...
export class ListServer {
  ...
  private addNextEntry(data: IAddEntriesData, options: IListOptions, addOptions: IAddEntryOptions,
                       fnResolve: (obj: IListData[]) => void, fnReject: (err: Error) => void): void {
  ...
  private listNextEntry(data: IAddEntriesData, options: IListOptions, fnResolve: (obj: IListData[]) => void,
