...
export class FileOps {
  ...
  public createDirectory(path: string, httpOptions: IHTTPOptions = {}): Promise<boolean> {
    ...
    if (!FileOps.isValidDirName(pathAndDir.dir)) {
      return this.taskController.getErrorPromise(APIErrors.createDir, [path], APIErrors.invalidDirName,
        [FileOps.getInvalidDirNameCharacters(pathAndDir.dir)]);
    }
  ...
  public reImport(path: string, service: string, image: boolean = true, metaData: boolean = true,
