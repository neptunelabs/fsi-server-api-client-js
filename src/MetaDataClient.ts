...
export class MetaDataClient {
  ...
  public setByFunction(entry: IListEntry, cmd: string = "saveMetaData",
  ...
  public set(path: string, service: string, data: IMetaData, cmd: string = "saveMetaData",
             options: IMetaDataOptions = {}): Promise<boolean> {

    return this.setWithQuery(path, service, MetaDataClient.GET_META_QUERY(data, cmd), options);
  }

  public setWithQuery(path: string, service: string, query: URLSearchParams,
                      options: IMetaDataOptions = {}): Promise<boolean> {
