...
import {TranslatableTemplate, ITranslations} from "./resources/TranslatableTemplate";
...
export class APITask {
    ...
    constructor(private taskSupplier: APITaskSupplier | null, private translations: ITranslations | undefined, private mainDef: IAPITaskDef, private mainContent: any[] = [],
